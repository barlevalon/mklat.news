...
const backendService = new gcp.compute.BackendService("mklat-news-backend", {
    ...
    // securityPolicy: securityPolicy.id, // Cloud Armor blocking Cloudflare IPs - need to fix ranges
});
...
// Temporarily disable geo-restriction - seems to be blocking Israeli IPs
